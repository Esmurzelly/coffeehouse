  ...
  return (
    <section id='aboutus' className='w-full flex justify-center mt-32 pb-4 px-4'>
      <motion.div
        ...
        className='flex flex-row justify-between items-center md:gap-10 xl:w-5/6 gap-7'
      >
        <div className='flex flex-col items-start w-[170px] sm:w-3/6'>
          <h1 className='text-sm font-semibold sm:text-[25px] xl:text-[45px] 4xl:text-[55px]'>Welcome to coffee vibe!</h1>
          <p className='text-[10px] font-light sm:text-[14px] xl:text-[25px] 4xl:text-[30px] sm:mt-3 xl:mt-6'>Our company believes that good coffee starts with the best beans, which is why we only use the best coffees in our expertly crafted blends. Our baristas take pride in every cup they make, ensuring every sip is a rich and flavorful delight that lingers long after you've had it.</p>
        </div>

        <img className='w-40 sm:w-2/6 xl:w-2/5' src={temp_coffeehouse} alt="" />
      </motion.div>
    </section>
  )
}
